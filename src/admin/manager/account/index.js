                    ...
                    <FormItem label="姓名">
                        {
                            getFieldDecorator('name',{
                                ...
                                <Input prefix={<Icon type="user" />}  placeholder="请填写真实姓名，一经填写不能修改"  autoComplete={false}/>
                            )
                        }
                    </FormItem>
                    <FormItem label="用户名">
                        {
                            getFieldDecorator('username',{
                                ...
                                <Input prefix={<Icon type="user-add" />} placeholder="请输入用户名，不包含中文" autoComplete={false}/>
                            )
                        }
                    </FormItem>
                    <FormItem label="密码">
